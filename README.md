...
![Model Comparison for CORA](outputs/cora_ml/plots/model_comparison.png) 
From the graph presenting the training and validation accuracy curves for all models for CORA dataset. Both M-ResGAT and MultiHop-ResGAT demonstrate faster convergence compared to baseline models, suggesting that incorporating higher-order structural information accelerates learning.
